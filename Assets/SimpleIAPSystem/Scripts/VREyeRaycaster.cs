...
namespace SIS
{
    ...
    public class VREyeRaycaster : MonoBehaviour
    {
        ...
        [SerializeField] private Transform m_Camera;                    // Reference to the camera transform casting the ray from.
        [SerializeField] private LayerMask m_ExclusionLayers;           // Layers to exclude from the raycast.
        [SerializeField] private VRReticle m_Reticle;                   // The reticle, if applicable.
        [SerializeField] private VRInput m_VrInput;                     // Used to call input based events on the current VRInteractiveItem.
        [SerializeField] private VRSelectionRadial m_SelectionRadial;   // The radial selection allowing for user confirmation.
